...
const MyFooter = () => {
    ...
    return (
        <Container className="mt-3" style={{ backgroundColor: '#F4F2EE' }}>
            <Row className="justify-content-around">
                <Col>
                    <small className="footer-text fw-bold">About</small><br></br>
                    <small className="footer-text fw-bold">Professional Community Policies</small>
                    <Form.Select aria-label="legal-stuff" style={{ color: '#7c7c7c', fontSize: '0.777rem', fontWeight: 'bold', border: 'none', paddingLeft: '0px', width: '130px', backgroundColor: '#F4F2EE' }}>
                    ...
                    <small className="footer-text fw-bold">Sales Solutions</small><br></br>
                    <small className="footer-text fw-bold">Safety Center</small>
                </Col>
                <Col>
                    <small className="footer-text fw-bold">Accessibility</small><br></br>
                    <small className="footer-text fw-bold">Careers</small><br></br>
                    <small className="footer-text fw-bold">Ad Choices</small><br></br>
                    <small className="footer-text fw-bold">Mobile</small>
                </Col>

                <Col >
                    <small className="footer-text fw-bold">Talent Solutions</small><br></br>
                    <small className="footer-text fw-bold">Marketing Solutions</small><br></br>
                    <small className="footer-text fw-bold">Advertising</small><br></br>
                    <small className="footer-text fw-bold">Small Business</small>
                </Col>

                <Col>
                    <div className="d-flex"><span><i className="bi bi-question-circle-fill fs-5" style={{ color: '#7c7c7c' }}></i></span> <span className="ms-2"><small style={{ color: '#7c7c7c', fontSize: '0.800rem', fontWeight: 'bold' }}>Questions?</small><p className="footer-text mb-2">Visit our Help Center.</p></span></div>
