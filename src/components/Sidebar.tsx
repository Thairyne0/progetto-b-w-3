...
const ContactsList: React.FC = () => {
  ...
  const fetchContacts = async () => {
    try {
      const response = await fetch('https://striveschool-api.herokuapp.com/api/profile/', {
        method: 'GET',
        headers: {
          Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzYwMmQ0ZjBlYTI4NjAwMTUyOGI5NjciLCJpYXQiOjE3MzQzNTYzMDMsImV4cCI6MTczNTU2NTkwM30.phVh9zVHPzoKzSOfmqoy-1YEIt4uO9h8tyuHSXJX_vU',  // Token da sostituire
        },
      });
  ...
  return (
    <div className="d-flex flex-column border p-3 text-start">
      ...
      <div>
        ...
        {contacts.length > 0 ? (
          contacts.slice(5, 10).map((contact) => (
            <div key={contact._id} className="d-flex align-items-center mb-3 border p-2 rounded">
              <img
                src={contact.image }
              ...
              <div>
                ...
                <p className="text-muted mb-1">{contact.title || 'Titolo non disponibile'}</p>
